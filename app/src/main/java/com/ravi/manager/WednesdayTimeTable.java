...
public class WednesdayTimeTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wednesday_time_table);
                   ...
                   // mondaySaveBtn.setVisibility(View.VISIBLE);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                Toast.makeText(WednesdayTimeTable.this, period1, Toast.LENGTH_SHORT).show();
                                mydb.execSQL("insert into timetable1(day,period1,period2,period3,period4,period5) values(?,?,?,?,?,?)",
                                        new Object[]{"Wednesday", period1, period2, period3, period4, period5});
                            } catch (Exception e) {
                                Toast.makeText(WednesdayTimeTable.this, "Unable to insert in table" + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                            mydb.close();
                            Toast.makeText(WednesdayTimeTable.this, "Saved Sucssefully!!", Toast.LENGTH_SHORT).show();
                            WednesdayTimeTable.this.finish();


                        } catch (Exception e) {
                            Toast.makeText(WednesdayTimeTable.this, "Unable to create table!!", Toast.LENGTH_SHORT).show();
                        }

                    } catch (Exception e) {
                        Toast.makeText(WednesdayTimeTable.this, "Unable to Create Database!!", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(WednesdayTimeTable.this, "Please Fill All Details", Toast.LENGTH_SHORT).show();
                ...
                if (a == 1 && b == 1 && c == 1 && d == 1 && e == 1)
                {
                    ...
                    try {
                        mydb.execSQL("update timetable1 set period1=?, period2=?, period3=?,period4=?, period5=?" +
                                "where day=?",new String[]{period1, period2, period3, period4, period5,"Wednesday"});


                        mydb.close();
                        Toast.makeText(WednesdayTimeTable.this, "Updated Successfully", Toast.LENGTH_SHORT).show();

                    }
                    catch(Exception e)
                    {
                        Toast.makeText(WednesdayTimeTable.this, "Error in Creating Table due to " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
